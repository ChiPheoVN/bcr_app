    ...
    <div class="menu-right">
      <div class="navbar user-panel-top">
        ...
        <div class="user-dropdown-details d-flex">
          <div class="profile_details_left d-none">
            ...
            <ul>
              <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                  ...
                  <li> <a href="{{ route('view-profile') }}"><i class="lnr lnr-user"></i>My Profile</a> </li>
                  <li class="d-none"> <a href="#"><i class="lnr lnr-users"></i>1k Followers</a> </li>
                  <li class="d-none"> <a href="#"><i class="lnr lnr-cog"></i>Setting</a> </li>
                  <li class="d-none"> <a href="#"><i class="lnr lnr-heart"></i>100 Likes</a> </li>
                  <li class="logout"> <a href="{{ route('logout') }}"><i class="fa fa-power-off"></i> Đăng xuất</a> </li>
                </ul>
              </li>
            </ul>
          </div>
